...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Vs JUPPAKPPAK Team"],
			["SAHA",		    'saha',	             "Background Artist", 	  "",	  "A29461"],
			["Lego0_77",	 'lego',		       "Main Programmer",		"",		"D2FF70"],
			["Ricethief",	    'ricethief',	   "Main Composer",			  "",	  "F2BEB7"],
			["HomeWork",    'homework',	    "Main Artist, Charter", "",		"999999"],
			["Zapzonzal",	  'zapzonzal',	  "Composer",					 "",	  "AF7E3C"],
			['Psych Engine Team'],
	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			...
			if(controls.ACCEPT) {
				if (creditsStuff[curSelected][3] != "") // prevents for non-page (Its not in psych engine) 
