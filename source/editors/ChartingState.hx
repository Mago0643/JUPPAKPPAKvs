...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Set Camera Zoom', "Value 1: To Zoom. Type 0 if you want to reset.\n\nWARNING: This is NOT same as Add Camera Zoom."],
		['Camera Flash', "You know What does this means."],
		['HUD Fade In/Out', "Value 1: Write Fade Out or Fade In you want.\nValue 2: Fade Time"],
		["Set Captions", "Value 1: The Caption's Text.\nType Nothing To Hide It"],
		["Play Video", "Value 1: Video Name\nVaule 2: Should Play End At Song?\n\nPlays a Video. (Don't overlap it)"]
	];
